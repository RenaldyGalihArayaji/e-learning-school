<form id="form-materi-pelajaran" enctype="multipart/form-data" action="{{ route('materi-pelajaran.store', $mataPelajaran->id) }}">
    @csrf
    <div class="row">
        <div class="col-md-4">
            <div class="mb-3">
    ...
    <button type="button" class="btn btn-primary mb-3" onclick="store({{ $mataPelajaran->id }})">Simpan</button>
</form>
