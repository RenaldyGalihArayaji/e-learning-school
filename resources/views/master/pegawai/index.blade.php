...
@section('content')
    <div class="title">
        <h1 class="h3 mb-0 text-gray-800">Master | <span class="text-secondary fs-5">Pegawai</span></h1>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function create() {
            $.get("{{ route('pegawai.create') }}", {}, function(data, status) {
                $("#staticBackdropLabel").html('Tambah Pegawai');
                $("#page").html(data);
        ...
        function store() {
            ...
            var dataToForm = $("#form-pegawai").serialize(); //Mengambil data di dalam form
        ...
        // Tampilan Modal Eidt
        function edit(id) {
            $.get("{{ url('master/pegawai') }}/" + id + "/edit", {}, function(data, status) {
                $("#staticBackdropLabel").html('Edit Pegawai');
                $("#page").html(data);
                $("#staticBackdrop").modal("show");
            });
        }
