    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nip" name="nip" placeholder="Masukan NIP Anda">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Cth: Guru Bk">
