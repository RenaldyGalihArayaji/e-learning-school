...
<body>
    ...
    <div class="filter">
        ...
        @endif
        @if(request('kelas_id'))
            Kelas: {{ optional($pengumpulanTugas->first()->siswa->kelas ?? null)->nama_kelas }}<br>
        @endif
        @if(request('pegawai_id'))
            Guru: {{ optional($pengumpulanTugas->first()->tugas->mataPelajaran->guruPengampu ?? null)->nama_lengkap }}<br>
        @endif
    </div>
    <table>
        <thead>
