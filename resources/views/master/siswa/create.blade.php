    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="angkatan" name="angkatan" placeholder="Cth. 2023/2024">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select name="kelas_id" id="kelas_id" class="form-control">
                    ...
                    <option value="{{ $item->id }}">{{ ucwords($item->nama_kelas) }}</option>
                    @endforeach
                </select>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="08xxxxxxxx">
        ...
        <div class="col-md-12">
            <div class="mb-3">
                ...
                <textarea class="form-control" id="alamat" name="alamat" placeholder="Masukan Alamat Anda" rows="3"></textarea>
